...
you only need simple posting into Teams

simplest setup, less control

`graph`

you need channel or chat posting through Graph

more control, more auth and target config
