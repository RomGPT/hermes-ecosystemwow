...
Optional — install with `hermes skills install official/finance/pptx-author`

Path

`optional-skills/finance/pptx-author`
...
`powerpoint`, `pptx`, `python-pptx`, `presentation`, `finance`

Related skills

[`excel-author`](/docs/user-guide/skills/optional/finance/finance-excel-author), [`powerpoint`](/docs/user-guide/skills/bundled/productivity/productivity-powerpoint)
