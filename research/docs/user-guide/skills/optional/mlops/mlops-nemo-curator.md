...
Optional — install with `hermes skills install official/mlops/nemo-curator`

Path

`optional-skills/mlops/nemo-curator`
...
-   **GitHub**: [https://github.com/NVIDIA/NeMo-Curator](https://github.com/NVIDIA/NeMo-Curator) ⭐ 500+
-   **Docs**: [https://docs.nvidia.com/nemo-framework/user-guide/latest/datacuration/](https://docs.nvidia.com/nemo-framework/user-guide/latest/datacuration/)
-   **Version**: 0.4.0+
-   **License**: Apache 2.0
