...
Optional — install with `hermes skills install official/blockchain/base`

Path

`optional-skills/blockchain/base`
...
`Base`, `Blockchain`, `Crypto`, `Web3`, `RPC`, `DeFi`, `EVM`, `L2`, `Ethereum`
