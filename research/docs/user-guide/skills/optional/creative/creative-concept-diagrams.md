...
Optional — install with `hermes skills install official/creative/concept-diagrams`

Path

`optional-skills/creative/concept-diagrams`
...
`diagrams`, `svg`, `visualization`, `education`, `physics`, `chemistry`, `engineering`

Related skills

[`architecture-diagram`](/docs/user-guide/skills/bundled/creative/creative-architecture-diagram), [`excalidraw`](/docs/user-guide/skills/bundled/creative/creative-excalidraw), `generative-widgets`
